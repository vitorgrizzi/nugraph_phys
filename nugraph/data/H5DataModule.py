...
from ..util import PositionFeatures, FeatureNormMetric, FeatureNorm, Rewiring, FeatureExtension
...
class H5DataModule(LightningDataModule):
    ...
    def __init__(self,
        ...
        #                      Rewiring.Rewiring(self.planes))
        #                     )

        # transform = Compose((PositionFeatures(self.planes),
        #                      FeatureNorm(self.planes, norm),
        #                      FeatureExtension.FeatureExtens5-ion(self.planes))
        #                     )
